...
research_agent = Agent(
    ...
    and synthesizing information across multiple domains. Your analytical skills allow you to 
    quickly identify key trends, separate fact from opinion, and produce insightful reports 
    on any topic. You excel at finding reliable sources and extracting valuable information efficiently.""",
    verbose=True,
...
writer_agent = Agent(
    ...
    backstory="""You are a skilled content strategist known for translating complex topics 
    into clear and compelling narratives. Your writing makes information accessible and 
...
print("\n[RESEARCH TASK]")
print(tasks_outputs[0].raw)

print("\n[WRITER TASK]")
print(tasks_outputs[1].raw)

print("\n[SOCIAL MEDIA TASK]")
print(tasks_outputs[2].raw)
